...
End-to-end agent that takes an issue from investigation through to a completed PR. Works with both GitHub and Azure DevOps.
...
# Azure DevOps
az repos pr show --id XXXXX --query "{title:title,description:description}"
az repos pr diff --id XXXXX
az boards work-item show --id XXXXX --query "{title:fields.\"System.Title\",description:fields.\"System.Description\"}"
```
...
# Azure DevOps
az boards work-item show --id XXXXX
```
...
# Azure DevOps
az repos pr diff --id XXXXX | grep -iE "test"
